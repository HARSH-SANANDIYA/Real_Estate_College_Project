							...
							<div class="card-body">
								<div class="form-group">
									...
									<select class="form-control"  placeholder="Enter Type Name" name="type">
                  						<option value="Office" <?php if ($fetch['type'] == 'Office') echo 'selected';  ?>>Office</option>
										<option value="Shop & Showroom" <?php if ($fetch['type'] == 'Shop & Showroom') echo 'selected';  ?>>Shop & Showroom</option>
									</select>
								</div>
								<div class="form-group">
